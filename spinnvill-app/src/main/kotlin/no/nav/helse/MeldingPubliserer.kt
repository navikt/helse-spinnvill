...
class MeldingPubliserer(
    ...
    fun behovløsningUtenVurdering(vurdering: Avviksvurdering) {
        val løsningMap =
            avviksvurderingBehov.json.toMutableMap().apply {
                this["@løsning"] =
                    mapOf(
                        "Avviksvurdering" to
                            buildMap {
            ...
            "beregningsgrunnlag" to
                mapOf(
                    ...
                    "omregnedeÅrsinntekter" to
                        vurdering.beregningsgrunnlag.omregnedeÅrsinntekter.map { (arbeidsgiverreferanse, beløp) ->
                            mapOf(
            ...
            "sammenligningsgrunnlag" to
                mapOf(
                    ...
                    "innrapporterteInntekter" to
                        vurdering.sammenligningsgrunnlag.inntekter.map { (arbeidsgiverreferanse, inntekter) ->
                            mapOf(
                                "arbeidsgiverreferanse" to arbeidsgiverreferanse,
                                "inntekter" to
                                    inntekter.map { (beløp, årMåned) ->
                                        mapOf(
                                            "årMåned" to årMåned,
                                            "beløp" to beløp,
                                        )
        ...
        val subsumsjon =
            SubsumsjonsmeldingDto(
                ...
                input =
                    mapOf(
                        "omregnedeÅrsinntekter" to
                            beregningsgrunnlag.omregnedeÅrsinntekter.map { (arbeidsgiverreferanse, omregnetÅrsinntekt) ->
                                mapOf(
            ...
            SubsumsjonsmeldingDto(
                ...
                input =
                    mapOf(
                        ...
                        "grunnlagForSykepengegrunnlag" to
                            mapOf(
                        ...
                        "sammenligningsgrunnlag" to
                            mapOf(
                                ...
                                "innrapporterteMånedsinntekter" to
                                    sammenligningsgrunnlag.inntekter
                                        .flatMap { (arbeidsgiverreferanse, inntekter) ->
                                            inntekter.map {
                                                arbeidsgiverreferanse to it
                                            }
                                        }.groupBy { (_, inntekt) -> inntekt.måned }
                                        .map { (måned, inntekter) ->
                                            mapOf(
                                                "måned" to måned,
                                                "inntekter" to
                                                    inntekter.map { (arbeidsgiverreferanse, inntekt) ->
                                                        mapOf(
                                                            "arbeidsgiverreferanse" to arbeidsgiverreferanse.value,
